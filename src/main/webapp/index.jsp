    ...
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div>
                ...
                <div>Fresas</div>
                <a href="AddToShoppingCart?product=strawberry" class="btn btn-default"> 2.20 €
                </a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div>
                ...
                <div>Naranjas</div>
                <a href="AddToShoppingCart?product=orange" class="btn btn-default"> 2.10 €
                </a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div>
                ...
                <div>Pan</div>
                <a href="AddToShoppingCart?product=breadd" class="btn btn-default"> 0.80 €
                </a>
            </div>
        </div>
    </div>
