...
<%
    ...
    if(name != null && name.equals("admin") && password != null && password.equals("admin")) {
        //Credencial valido, lo guarda en sesion
...
<div class="container" id="main-container">
    ...
    <form class="form-horizontal" method="post" action="login.jsp">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10"> <input type="password" class="form-control" id="password" name="password" required="true"/></div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10"> <button type="submit" class="btn btn-primary">Agregar</button></div>
        </div>
    </form>
</div>
</body>
